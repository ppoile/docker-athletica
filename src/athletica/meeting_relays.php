...
<frameset rows="74,*" frameborder="NO" border="0" framespacing="0">
	<frame name="header" src="meeting_relays_header.php" marginwidth="0"
		marginheight="0" scrolling="no" frameborder="0" noresize />
	<frameset cols="300,*" frameborder="1" border="1" framespacing="1">
      <frame name="list" src="meeting_relaylist.php" marginwidth="0"
