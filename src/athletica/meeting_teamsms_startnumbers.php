...
/**********
 *
 *	meeting_teamsms_startnumbers.php
 *	--------------------------------
 *	
 */            
...
if($_GET['arg'] == 'assign')
{
	...
	{
		mysql_query("LOCK TABLE teamsm WRITE");
...
$page = new GUI_Page('meeting_teamsms_startnumbers');
$page->startPage();
...
<form action='meeting_teamsms_startnumbers.php' method='get' id='startnr'>
